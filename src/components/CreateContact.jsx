...
export default function CreateContact({ setContacts, contacts }) {
    ...
    return (
        <div className="flex flex-col items-center bg-gradient-to-r from-blue-500 via-green-500 to-yellow-500 min-h-screen p-10">
            ...
            >
                <input
                    className="w-full h-14 p-4 mb-6 rounded-lg bg-gray-100 focus:outline-none focus:ring-4 focus:ring-green-500 transition duration-300 placeholder-gray-500"
                    type="text"
                    placeholder="Name"
                    value={values.name}
                ...
                <button
                    type="submit"
                    className="bg-green-500 text-white py-3 px-8 rounded-full font-medium shadow-md transition duration-300 transform hover:scale-105 hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-700"
                >
